                    ...
                    @foreach ($brochures as $project)
                        <div class="utf_listing_titlebar_title">
                            ...
                            <div class="utf_star_rating_section"
                                data-rating="{{ $numberOfReviews > 0 ? $averageRating : 0 }}">
                ...
                <li><a href="#"><i class="fa fa-share"></i> Share</a></li>
                    ...
                    <div class="utf_box_widget margin-top-35">
                        ...
                        @foreach ($brochures as $agent)
                            <div class="utf_hosted_by_user_title"> <a href="#"
                                    class="utf_hosted_by_avatar_listing">
                                    <img src="{{ asset($agent->profile_picture) }}" alt="Profile Picture" width="20"
                                        height="20">
                    ...
                    --}}
                                ...
                                @if ($agent->facebook)
                                    <li><a class="facebook" href="{{ asset($agent->facebook) }}"><i
                                                class="icon-facebook"></i></a></li>
                                @endif

                                @if ($agent->twitter)
                                    <li><a class="twitter" href="{{ asset($agent->twitter) }}"><i
                                                class="icon-twitter"></i></a></li>
                                @endif

                                @if ($agent->linkedin)
                                    <li><a class="linkedin" href="{{ asset($agent->linkedin) }}"><i
                                                class="icon-linkedin"></i></a></li>
                                @endif

                                @if ($agent->instagram)
                                    <li><a class="instagram" href="{{ asset($agent->instagram) }}"><i
                            ...
                            <ul class="utf_listing_detail_sidebar">
                                ...
                                <li><i class="fa fa-envelope-o"></i> <a
                                        href="mailto:info@example.com">{{ $agent->email }}</a></li>
                            </ul>
                    </div>
                    @endforeach
                                ...
                                <li style="margin-top: 10px">{{ $businessHours->days_name->days }}
                                    ...
                                    @else
                                        <span>{{ Carbon::createFromFormat('H:i', $businessHours->open_at)->format('h:i A') }}
                                            -
                                            {{ Carbon::createFromFormat('H:i', $businessHours->close_at)->format('h:i A') }}</span>
                                    @endif
                                </li>
                            @endforeach
