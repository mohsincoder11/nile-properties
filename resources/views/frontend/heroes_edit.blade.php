            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="card-title">Update Heroes & Leaders</h5>
                        <hr />
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div style="margin-top: -12px;">
                                                        ...
                                                        <input type="file" class="form-control" id="file"
                                                            ...
                                                            value="{{ old('image', $hero->image) }}" name="image">
                                                        @if ($errors->has('image'))
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label for="inputProductTitle" class="form-label">
                                                        Title</label>
                                                    <input type="text" value="{{ old('title', $hero->title) }}"
