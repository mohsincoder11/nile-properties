            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="card-title">Update Competition</h5>
                        <hr />
                        @if(session('success'))
                        ...
                        <div class="form-body mt-4">
                            <div class="page-content" style="padding-top:0px;">
                                ...
                                <form action="{{route('Competition.update', ['id' => $Competition->id])}}" method="post"
                                    ...
                                    <div class="col-md-12 mx-auto">
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <div style="margin-top: -12px;">
                                                        ...
                                                        <input type="file"
                                                            value="{{ old('image', $Competition->image) }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Title"
                                                        name="title" value="{{ old('title', $Competition->title) }}">
                                                    @if ($errors->has('title'))
                                        ...
                                        <div class="mb-3" style="margin-top:2%;">
                                            ...
                                            <textarea id="main_description"
                                                name="text">{{ old('text', $Competition->text) }}</textarea>
                                            @if ($errors->has('text'))
