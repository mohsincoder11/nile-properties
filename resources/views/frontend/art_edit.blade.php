            ...
            <div class="col-md-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="card-title">Update Art</h5>
                        <hr />
                        @if(session('success'))
                                ...
                                <form action="{{ route('Art.update', ['id' => $art->id]) }}" method="post"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div style="margin-top: 8px;">
                                                        ...
                                                        <input type="file" class="form-control"
                                                            value="{{ old('image', $art->image) }}" id="file"
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label for="inputProductTitle" class="form-label">
                                                        Title</label>
                                                    <input type="text" value="{{ old('title', $art->title) }}" class="
                                    ...
                                    <div class="mb-3" style="margin-top:2%;">
                                        ...
                                        <textarea id="main_description"
                                            name="text"> {{ old('text', $art->text) }}</textarea>
                                        @if ($errors->has('text'))
                        ...
                        <div class="row" style="margin-top:4%; margin-left: %;">
                            ...
                            <div class="program-block col-lg-12 col-md-12 col-sm-12 wow fadeInUp">
                                ...
                                <div class="lower-content"
                                    ...
                                    <div class="text spectral font1" style=" padding-top:12px; text-align: justify;">
                                        <img src="assets/images/circle.png" style="height:13px;" alt="">
