            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="card-title">Add Competition</h5>
                        <hr />
                        @if(session('success'))
                        ...
                        <div class="form-body mt-4">
                            <div class="page-content" style="padding-top:0px;">
                                ...
                                <form action="{{route('user.CompetitionStore')}}" method="post"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('Competition.edit', ['id' => $Heroes->id]) }}">
                                            ...
                                            <a href="#"
                                                onclick="openCustomModal('{{ route('user.destroyCompetition', $Heroes->id) }}')">
