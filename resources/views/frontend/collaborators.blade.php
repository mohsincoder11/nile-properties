            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="card-title">Add Collaborators</h5>
                        <hr />
                        @if(session('success'))
                        ...
                        <div class="form-body mt-4">
                            <div class="page-content">
                                ...
                                <form role="form" method="post" action="{{ route('collaborators.store') }}"
...
<div class="col-md-12" style="margin-left: 15%; width: 77%; margin-top: -40px;">
                            ...
                            <table id="example" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{asset('public/images/' . $Collaborators->logo) }}" target="_blank">
                                                @if ($Collaborators->image)
                                                <img height="50px" width="50px"
                                                    src="{{asset('public/images/' . $Collaborators->logo) }}" alt="" />
                                                @else
                                        ...
                                        <td>
                                            {!! Str::limit(strip_tags($Collaborators->text), 10) !!}</td>
                                        <td>{{$Collaborators->facebook}}</td>
                                        <td>{{$Collaborators->website}}</td>
                                        <td>
											<div style="display:flex;">
											<div>
                                                                         <a href="{{ route('collaborators.edit', ['id' => $Collaborators->id]) }}"  >
    ...
    <i class='bx bx-edit-alt me-0'></i>
                                          ...
                                          <div>
                                            <a href="#"
                                                onclick="openCustomModal('{{ route('Collaborators.destroy', $Collaborators->id) }}')">
