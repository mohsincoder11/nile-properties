            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="card-title">Add Quiz (Indiayatra)</h5>
                        <hr />
                        @if(session('success'))
                        ...
                        <div class="form-body mt-4">
                            <div class="page-content">
                                ...
                                <form role="form" method="post" action="{{ route('QuizIndiyatra.store') }}"
                            ...
                            <table id="example1" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @endif
                                        ...
                                        <td>
                                            <a href="{{ route('QuizIndiyatra.edit', $Collaborators->id) }}"
                                                class="btn1 btn-outline-success" title="edit">
                                                <i class='bx bx-edit-alt me-0'></i>
                                            </a>

                                            <a href="#"
                                                onclick="openCustomModal('{{ route('QuizIndiyatra.destroy', $Collaborators->id) }}')">
