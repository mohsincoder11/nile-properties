            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="card-title">Add Sports</h5>
                        <hr />
                        @if(session('success'))
                        ...
                        <div class="form-body mt-4">
                            <div class="page-content" style="padding-top:0px;">
                                ...
                                <form action="{{route('user.Sportstore')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <img height="50px" width="50px"
                                                    src="{{asset('public/images/' . $Sport->image)}}" alt="" />
                            @else
                            ...
                            @endif
                                        ...
                                        <td>
                                            {!! Str::limit(strip_tags($Sport->title), 20) !!}</td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn1 btn-outline-success viewinfo" title="Show"
                                                ...
                                                id="{{ $Sport->id }}"><i class='bx bx-show-alt me-0'></i></button>

                                            <a href="{{ route('Sport.edit', ['id' => $Sport->id]) }}">
                                                <button type="button" class="btn1 btn-outline-success"><i
                                                        class='bx bx-edit-alt me-0' title="edit"></i></button> </a>

                                            <a href="#"
                                                onclick="openCustomModal('{{ route('user.destroySports', $Sport->id) }}')">
