...
<section class="page-banner curve-offwhite"
    ...
    <div class="auto-container">
        <h1 class="spectral" style="font-size: 60px;"><img src="{{ asset ('images1/starting-title.gif')}}"
                style="height:250px;" alt="">Heroes & Leaders</h1>
            ...
            <div class="image-column col-lg-6 col-md-12 col-sm-12"
                ...
                <div class="inner-column" style="padding-left: 0; padding-bottom: 80px; padding-top: 20px;">
                    <figure class="image wow fadeInLeft">
                        ...
                        @if ($heroes->image)
                        <img style="max-width: 100%; height: auto;" src="{{asset('public/images/' . $heroes->image) }}"
                            alt="Image">
                        @else
            ...
            <div class="content-column col-lg-6 col-md-12 col-sm-12" style="margin-bottom:0px; margin-bottom:5%;">
                <div class="inner-column">
                    <div class="sec-title" style="margin-bottom:10px;">
                        <h2 style="color:black; font-family: 'ADLaM Display', sans-serif; font-size:28px;">
                            {{($heroes->title)}}</h2>
                    </div>
                    <div class="offer-block col-lg-12 col-md-6 col-sm-12 wow fadeInUp" style="margin-bottom:0px;">
                        <div class="row">
                            <p class="font1 spectral" style="text-align: justify;">
                                {!! $heroes->text !!}</p>
