        ...
        <div class="col-md-12" style="margin-top: 2vh;">
            ...
            <form action="{{route('token_store')}}" method="post">
                ...
                <div class="col-md-2" style="margin-top:15px;">
                    <button id="on" type="submit" class="btn mjks" style="color:#FFFFFF; height:30px; width:auto;"> <i
                            class="fa fa-plus"></i>ADD</button>
                    <button id="on" type="button" data-toggle="modal" data-target="#popup12345_1" class="btn mjks"
                        style="color:#FFFFFF; height:30px; width:auto;"> <i class="fa fa-gear"></i>Manage</button>
        ...
        <form action="{{route('occupation_store')}}" method="post">
            ...
            <div class="col-md-12" style="margin-top: 2vh;">
                ...
                <div class="col-md-2" style="margin-top:15px;">
                    <button id="on" type="submit" class="btn mjks" style="color:#FFFFFF; height:30px; width:auto;"> <i
                            class="fa fa-plus"></i>ADD</button>
                    <button id="on" type="button" data-toggle="modal" data-target="#popup4" class="btn mjks"
                        style="color:#FFFFFF; height:30px; width:auto;"> <i class="fa fa-gear"></i>Manage</button>
...
<!-- ==========================End token Model===================================== -->
<!-- ============================================Occupation Model================================= -->
<div class="modal" id="popup4" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="openDeleteModal('{{ route('occupation_destroy', $occupation->id) }}')">
                                        <button
                                            style="background-color:#ff0000; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;"
                                            type="button" class="btn btn-info" data-toggle="tooltip"
                                            data-placement="top" title="Delete">
...
<!-- =============================================================End Model========================== -->
<!-- ================================================Layout Model===================================== -->
<div class="modal" id="popup5" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" value="{{$layout->id}}"
                                        ...
                                        style="background-color:#3399ff; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;"
                                        class="btn editbtnlayout btn-info" data-toggle="tooltip" data-placement="top"
...
<!-- ============================================================End Layout Model========================= -->
<!-- =========================================sale status model===================== -->
<div class="modal" id="popup6" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button value="{{$plot->id}}" plot_name="{{$plot->plot_sale_status}}"
                                        data-toggle="modal"
                                        style="background-color:#3399ff; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;"
...
<!-- ======================================End model================================== -->
<!-- =========================================Transaction model===================== -->
<div class="modal" id="popup7" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button data-toggle="modal" value="{{$transaction->id}}"
                                        ...
                                        style="background-color:#3399ff; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;"
                                        type="button" class="btn editbtntransaction btn-info" data-toggle="tooltip"
                                        data-placement="top" title="Edit"><i class="fa fa-edit"
                                            style="margin-left:5px;"></i></button>
...
<div class="modal" id="popup8" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
                    ...
                    <div class="col-md-12">
                        <form action="{{ route('update_city')}}" method="post">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="city" value="" class="form-control" name="city" required
                                    placeholder="" />
                            </div>
                    ...
                    <div class="col-md-12">
                        <form action="{{ route('update_token')}}" method="post">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="token" required value="" class="form-control" name="token"
                                    placeholder="" />
                            </div>
...
<div class="modal" id="popup9" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
...
<div class="modal" id="popup10" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
...
<div class="modal" id="popup11" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
...
<div class="modal" id="popup12" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
