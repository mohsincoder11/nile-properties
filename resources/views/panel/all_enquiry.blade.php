        ...
        <div class="col-md-12" style="margin-top:1px;">
            <div class="panel panel-default">
                <h5 class="panel-title"
                    ...
                    align="center">
                    <i class="fa fa-file-text"></i> &nbsp;All Enquiry
                </h5>
                ...
                <div class="col-md-12">
                    <table width="100%">
                        ...
                        <tr style="height:30px;">
                            ...
                            <td style="padding: 2px;" width="1%">
                                <label class="control-label">Mobile No: <font color="#000099">95799 15551</font></label>
                            </td>
                            <td style="padding: 2px;" width="1%">
                        ...
                        <tr style="height:30px;">
                            ...
                            <td style="padding: 2px;" width="1%">
                                <label class="control-label">Plot Status : <font color="#000099">Booked</font> </label>
                            </td>
                            <td style="padding: 2px;" width="1%">
                        ...
                        <tr style="height:30px;">
                            ...
                            <td style="padding: 2px;" width="4%">
                                <label class="control-label">Executive Name : <font color="#000099">Pratik Mohod</font>
                                </label>
                            </td>
