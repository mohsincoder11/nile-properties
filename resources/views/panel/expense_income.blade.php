        ...
        <div class="row">
            ...
            <form action="{{ route('expense.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12 info_div" style="display:none">
                    ...
                    <div class="col-md-2" style="margin-top: 1vh;">
                        <label class="control-label">Total Cost: <font id="text_total_cost" color="#ff0000">1,10,00000</font></label>
                    </div>
                    <div class="col-md-2" style="margin-top: 1vh;">
                        <label class="control-label">Paid Amount: <font id="text_paid_amount" color="#ff0000">10</font></label>
                    </div>
                    <div class="col-md-2" style="margin-top: 1vh;">
                        <label class="control-label">Balance Amount: <font id="text_balance_amount" color="#ff0000">5</font></label>
                    </div>
                    <div class="col-md-2" style="margin-top: 1vh;">
                    ...
                    <div class="col-md-2" style="margin-top: 1vh;">
                        <label class="control-label">Other Charges: <font id="text_other_charges" color="#ff0000">1100</font></label>
                    </div>
                </div>
