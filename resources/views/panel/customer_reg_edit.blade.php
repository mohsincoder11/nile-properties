                        ...
                        <tr>
                            ...
                            <td style="padding: 2px;" width="1%">
                                <select class="form-control select" data-live-search="true" name="title">
                                    <option value="Mr."
                                        {{ old('title', $customerEdit->title) == 'Mr.' ? 'selected' : '' }}>Mr.</option>
                                    <option value="Mrs."
                                        {{ old('title', $customerEdit->title) == 'Mrs.' ? 'selected' : '' }}>Mrs.</option>
                                    <option value="Ku."
                                        {{ old('title', $customerEdit->title) == 'Ku.' ? 'selected' : '' }}>Ku.</option>
                                    <option value="Shri."
                                        {{ old('title', $customerEdit->title) == 'Shri.' ? 'selected' : '' }}>Shri.
                                    </option>
                                    <option value="Miss"
                                        {{ old('title', $customerEdit->title) == 'Miss' ? 'selected' : '' }}>Miss</option>
                                    <option value="Mast."
                                        {{ old('title', $customerEdit->title) == 'Mast.' ? 'selected' : '' }}>Mast.
                                    </option>
                                    <option value="Smt."
                                        {{ old('title', $customerEdit->title) == 'Smt.' ? 'selected' : '' }}>Smt.</option>
                                ...
                                <option>Other</option> --}}
                                    ...
                                    @foreach ($occupation as $occupation_name)
                                        <option value="{{ $occupation_name->id }}"
                                            {{ old('occupation_id', $customerEdit->occupation_id) == $occupation_name->id ? 'selected' : '' }}>
                                ...
                                <option>Amravati</option> --}}
                                    ...
                                    @foreach ($branch as $branch_name)
                                        <option value="{{ $branch_name->id }}"
                                            {{ old('branch_id', $customerEdit->branch_id) == $branch_name->id ? 'selected' : '' }}>
