...
@section('main_container')
    ...
    <div class="page-content-wrap" style="height: 200px;">
        <div class="row">
            ...
            <div class="col-md-12" style="margin-top:1vh;" style="display: none;">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            document.getElementById('razorpay_order_id').value = response
                                .response.orderId;
                            $('#storeInstallmentModal').find(
                    ...
                    success: function(response) {
                        ...
                        const options = {
                            ...
                            "handler": function(response) {
                                ...
                                $('#user_razorpay_order_id').val(response
                                    .razorpay_order_id);
                                $('#user_razorpay_payment_id').val(response
                                    .razorpay_payment_id);

                                // Submit the form via AJAX
                                $.ajax({
                                    url: $('#user-razorpay-form').attr(
                                        'action'),
                                    method: 'POST',
