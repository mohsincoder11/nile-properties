                            ...
                            <div class="col-md-12" style="margin-top: 2vh;">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        @php
                                            $user = auth()->user();
                                            // $isUserInCustomerMaster = \App\Models\CustomerRegistrationMaster::where('user_id',
                                            // auth()->user()->id)->exists();
                                        @endphp
                            ...
                            <div class="col-md-12" style="margin-top: 2vh;">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px;" width="2%">
                                            <input type="text" class="form-control" id="west" name="west"
                                                placeholder="" required />
                                        </td>
                                        <td style="padding: 2px;" width="2%">
                                            <input type="text" class="form-control" id="north" name="north"
                                                placeholder="" required />
                                        </td>
