...
@section('main_container')
    ...
    <div class="page-content-wrap">
        ...
        <form action="{{ route('agent_reg_update') }}" method="post">
            @csrf
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td style="padding: 2px;" width="5%">
                                <select class="form-select select" name="parent_id">
                                    ...
                                    @foreach ($agentAll as $a)
                                        <option value="{{ $a->id }}"
                                            @if ($agentEdit->parent_id == $a->id) {{ 'selected' }} @endif>
                                            {{ $a->name }}</option>
                                    @endforeach
                            ...
                            <td style="padding: 2px;" width="3%">
                                <input type="text" class="form-control" maxlength="10" name="contact_number"
                                    placeholder="" value="{{ $agentEdit->contact_number }}" />
                            </td>
                            <td style="padding: 2px;" width="4%">
                ...
                <tbody class="add_more">
                    ...
                    @foreach ($agentListEdit as $agentListEdit)
                        ...
                        <label>1</label>
                            ...
                            <td>
                                <input type="hidden" name="existing_id[]" value="{{ $agentListEdit->id }}"> <input
                                    type="hidden" name="agent_id[]" value="{{ $agentListEdit->agent_id }}"><input
                                    type="text" required="" style="border:none; width: 100%;"
                                    name="account_holder_name[]" value="{{ $agentListEdit->account_holder_name }}">
                            </td>
                            <td><input type="text" name="bank_name[]" required=""
                                    style="border:none; width: 100%;" value={{ $agentListEdit->bank_name }}></td>

                            <td><input type="text" name="account_number[]" required=""
                                    style="border:none; width: 100%;" value={{ $agentListEdit->account_number }}></td>

                            <td><input type="text" name="ifsc[]" required="" style="border:none; width: 100%;"
                                    value={{ $agentListEdit->ifsc }}></td>

                            <td style="text-align:center;">
                                <a href="{{ route('agent_list_destroy', $agentListEdit->id) }}">
    ...
    <script>
        $(document).ready(function() {
            $(".add-row").click(function() {
                ...
                var markup =
                    '<tr><td><input type="text" name="bank_name[]" required="" style="border:none; width: 100%;" value="' +
                    bankName + '"></td>' +
                    ...
                    ifsc + '"></td>' +
                    '<td><input type="text" name="account_holder_name[]" required="" style="border:none; width: 100%;" value="' +
