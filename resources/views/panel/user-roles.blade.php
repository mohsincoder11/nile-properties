            ...
            <div class="col-md-12">
                ...
                <div class="panel-body" style="padding:1px 5px 2px 5px;">
                    ...
                    <form action="{{ route('user-roles-store') }}" method="post">
                        @csrf
                        <div class="col-md-12" style="margin-top: 10px; margin-left:600px; margin-bottom:20px">
                            <div class="row">
                                <div class="col-md-2 flex-column align-items-center">
                                    <label class="control-label " style="margin-left:80px;">Add Role<font color="#FF0000">*
                                        </font></label>
                        ...
                        <div class="row g-2" style="margin-left: 10px">
                            <div class="col-md-2">
                                <label for="inputFirstName" class="form-label" style="font-weight: bold; font-size:13px">
                                    Master
                                    :</label>
                            </div>
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="col-md-8">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault6">City / Other Charges / Token
                                            / Occupation /
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="branch" name="permission[]"
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="firm_reg" name="permission[]"
                                            id="flexCheckDefault6">
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="emp_reg" name="permission[]"
                                            id="flexCheckDefault6">
                ...
                <div class="row g-2" style="margin-top: 20px; margin-left:10px">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="allenquiry" name="permission[]"
                                    id="flexCheckDefault">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="enquiry" name="permission[]"
                                    id="flexCheckDefault">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="visitindex" name="permission[]"
                                    id="flexCheckDefault">
                ...
                <div class="row g-2" style="margin-top: 20px; margin-left:10px">
                    <div class="col-md-2">
                        <label for="inputFirstName" class="form-label" style="font-weight: bold; font-size:13px">Sales
                            Stages:
                        </label>
                    </div>
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="initiatesale" name="permission[]"
                                    id="flexCheckDefault">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="newsale" name="permission[]"
                                    id="flexCheckDefault">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="registration" name="permission[]"
                                    id="flexCheckDefault">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="saledeedscan" name="permission[]"
                                    id="flexCheckDefault">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="handover" name="permission[]"
                                    id="flexCheckDefault">
                ...
                <div class="row g-2" style="margin-top: 20px; margin-left:10px">
                    <div class="col-md-2">
                        <label for="inputFirstName" class="form-label"
                            style="font-weight: bold; font-size:13px">Business:
                        </label>
                    </div>
                ...
                <div class="row g-2" style="margin-top: 20px; margin-left:10px">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="reports" name="permission[]"
                                    id="flexCheckDefault">
                ...
                <div class="row g-2" style="margin-top: 20px; margin-left:10px">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="user-logs" name="permission[]"
                                    id="flexCheckDefault">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="user-roles" name="permission[]"
                                    id="flexCheckDefault">
                ...
                <div class="col-md-12" style="margin-top:20px;" align="center">
                    <button id="on" type="submit" class="btn mjks"
                        style="color:#FFFFFF; height:30px; width:150px;">
