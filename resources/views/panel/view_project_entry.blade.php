    ...
    <table width="100%" class="col-md-12">
        ...
        <tr style="height:30px;">
            <td style="padding: 2px;" width="1%">
                <label class="control-label"> Branch: <font color="#000099">
                        {{ $servicearea->cityname->city ?? null }}
                    </font>
                </label>
            </td>
            <td style="padding: 2px;" width="1%">
                <label class="control-label">Project Code: <font color="#000099">
                        {{ $servicearea->project_code ?? null }}</font>
                </label>
            </td>
            <td style="padding: 2px;" width="1%">
                <label class="control-label">Project Name: <font color="#000099">
                        {{ $servicearea->project_name ?? null }}</font>
                </label>
            </td>
            <td style="padding: 2px;" width="1%">
            ...
            <td style="padding: 2px;" width="1%">
                <label class="control-label">WhatsApp No: <font color="#000099">
                        {{ $servicearea->whatsapp_number ?? null }}
                    </font>
                </label>
            </td>
        </tr>
        ...
        <tr style="height:30px;">
            ...
            <td style="padding: 2px;" width="1%">
                <label class="control-label">District: <font color="#000099">{{ $servicearea->district ?? null }}
                    </font>
                </label>
            </td>
            <td style="padding: 2px;" width="1%">
                <label class="control-label">No. of Plots: <font color="#000099">
                        {{ $servicearea->no_of_plots ?? null }}
                    </font>
                </label>
            </td>
            <td style="padding: 2px;" width="1%">
                <label class="control-label">Area (Sq. Ft): <font color="#000099">
                        {{ $servicearea->areasqrft_manual ?? null }}
                    </font></label>
            </td>
            <td style="padding: 2px;" width="1%">
                <label class="control-label">Area (Sq. Mt): <font color="#000099">
                        {{ $servicearea->areasqrmt_manual ?? null }}
                    </font></label>
            </td>
            <td style="padding: 2px;" width="1%">
        ...
        <tr style="height:30px;">
            ...
            <td style="padding: 2px;" width="1%">
                <label class="control-label">Dev.Charge (₹): <font color="#000099">{{ $servicearea->dev_charge }}
                    </font>
                </label>
            </td>
            <td style="padding: 2px;" width="1%">
        ...
        <tr style="height:30px;">
            ...
            <td style="padding: 2px;" width="1%">
                ...
                <a href="{{ asset('/' . $servicearea->brochure) }}" download target="_blank"><span
                        style="color: blue">
        ...
        <tr style="height:30px;">
            ...
            <td style="padding: 2px;" width="1%">
                <label class="control-label">Feature: <font color="#000099">
                        {{ Str::limit($servicearea->layout_feature, 20) }}
                    </font> </label>
            </td>
            <td style="padding: 2px;" width="1%">
        ...
        <tr>
            <table width="100%" border="1" style="margin-top: 5px;">
                <tr style="background-color:#f0f0f0; height:30px;">
                    ...
                    <th width="5%" style="text-align:center">Minimum Down Payment </th>
                ...
                @foreach ($appendData as $index => $data)
                    <tr>
                        ...
                        <td style="padding:5px;" align="center">{{ $data->minimum_down_payment ?? '' }}</td>
                        <td style="padding:5px;" align="center">{{ $data->tenure ?? '' }}</td>
                    </tr>
                @endforeach
            </table>
        </tr>
