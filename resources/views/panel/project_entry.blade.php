                ...
                <table width="100%">
                    ...
                    <tbody>
                        ...
                        <tr width="100%">
                            ...
                            <td style="padding: 2px;" width="3%">
                                <input type="text" class="form-control" name="project_code" placeholder="" required />
                            </td>
                            ...
                            <td style="padding: 2px;" width="3%"><input type="email" class="form-control" name="email"
                                    placeholder="" required /></td>
                            <td style="padding: 2px;" width="3%"><input type="text" class="form-control" name="mauja"
                                    placeholder="" required /></td>
                            <td style="padding: 2px;" width="3%"><input type="text" class="form-control" name="kh_no"
                                    placeholder="" required /></td>
                ...
                <table width="100%">
                    ...
                    <tbody>
                        ...
                        <tr width="100%">
                            ...
                            <td style="padding: 2px;" width="3%"><input type="text" class="form-control" name="phn"
                                    placeholder="" required /></td>
                            <td style="padding: 2px;" width="5%"><input type="text" class="form-control" name="taluka"
                                    placeholder="" required /></td>
                            <td style="padding: 2px;" width="3%"><input type="text" class="form-control" name="district"
                                    placeholder="" required /></td>
                            <td style="padding: 2px;" width="3%"><input type="text" class="form-control"
                            ...
                            <td style="padding: 2px;" width="3%">
                                <input type="text" class="form-control" name="embedded_map" placeholder="" required />
                            </td>
                            ...
                            <td style="padding: 2px;" width="5%">
                                <input type="text" class="form-control" name="area_plottable" placeholder="" required />
                            </td>
                            <td style="padding: 2px;" width="3%">
                                <input type="text" class="form-control" name="amenities" placeholder="" required />
                            </td>
                            <td style="padding: 2px;" width="5%">
                                <input type="text" class="form-control" name="open_space" placeholder="" required />
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="col-md-12" style="margin-top: 5px;">
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr width="100%">
                            <td style="padding: 2px;" width="3%">
                                <input type="text" class="form-control" name="dev_charge" placeholder="" required />
                            </td>
                            <td style="padding: 2px;" width="3%">
                                <input type="text" class="form-control" name="other_charges_percentage" placeholder=""
                                    required />
                            </td>
                            <td style="padding: 2px;" width="5%">
                                <input type="file" class="form-control" name="site_map" placeholder="" required />
                            </td>
                            <td style="padding: 2px;" width="5%">
                                <input type="file" class="form-control" name="brochure" placeholder="" required />
                            </td>
                            <td style="padding: 2px;" width="5%">
                            ...
                            <td style="padding: 2px;" width="5%">
                                <input type="text" class="form-control" name="youtube_url" placeholder="" required />
                            </td>
                    ...
                    <tbody>
                        <tr width="100%">
                            <td style="padding: 2px;" width="4%">
                                <input type="text" class="form-control" name="agent_name" placeholder="" required />
                            </td>
                            <td style="padding: 2px;" width="4%">
                                ...
                                <div class="row">
                                    <div class="col-lg-6" style="position: relative; margin-top: 15px">
                                        ...
                                        <input type="time" name="open_at_{{ $day->id }}" id="open_at_{{ $day->id }}"
                                            class="form-control openCloseField" style="height: 50px;" value="10:00">
                                    </div>
                                    ...
                                    <div class="col-lg-6" style="position: relative; margin-top: 15px">
                                        ...
                                        <input type="time" name="close_at_{{ $day->id }}" id="close_at_{{ $day->id }}"
                                            class="form-control openCloseField" style="height: 50px;" value="22:00">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tr>
                                    <td style="padding: 2px; " width="50%">
                                        <div style="margin-bottom:5%;">
                                            ...
                                            <label style="margin-bottom: 5px;" for="{{ $feature->id }}">{{
                                                $feature->layout_feature }}</label>
                                            @endforeach
...
var plotrecordlenrth=0;
   $('#upload-button').on('click', function(e) {
    ...
    '<tr>' +
        ...
        '<td><input type="text" name="plotno[]" required style="border:none; width: 100%;" value="' + row.plot_no + '"></td>' +
        '<td><input type="text" name="plotwidth[]" required style="border:none; width: 100%;" value="' + row.plot_width + '"></td>' +
        '<td><input type="text" name="plotlength[]" required style="border:none; width: 100%;" value="' + row.plot_length + '"></td>' +
        '<td><input type="text" name="areasqrft[]" required style="border:none; width: 100%;" value="' + row.area_sqrft + '"></td>' +
        '<td><input type="text" name="areasqrmt[]" required style="border:none; width: 100%;" value="' + row.area_sqrmt + '"></td>' +
        '<td><input type="text" name="east[]" required style="border:none; width: 100%;" value="' + row.east + '"></td>' +
        '<td><input type="text" name="west[]" required style="border:none; width: 100%;" value="' + row.west + '"></td>' +
        '<td><input type="text" name="south[]" required style="border:none; width: 100%;" value="' + row.south + '"></td>' +
        '<td><input type="text" name="north[]" required style="border:none; width: 100%;" value="' + row.north + '"></td>' +
        '<td><input type="text" name="rate[]" required style="border:none; width: 100%;" value="' + row.rate + '"></td>' +
        '<td><input type="text" name="amount[]" required style="border:none; width: 100%;" value="' + row.amount + '"></td>' +
    ...
    '<tr>' +
        // '<td style="text-align:center;">' + srNo + '</td>' +
        '<td><input type="text" name="plotno[]" required="" style="border:none; width: 100%;" value="' + plotNo + '"></td>' +
        '<td><input type="text" name="plotwidth[]" required="" style="border:none; width: 100%;" value="' + plotWidth + '"></td>' +
        '<td><input type="text" name="plotlength[]" required="" style="border:none; width: 100%;" value="' + plotLength + '"></td>' +
        '<td><input type="text" name="areasqrft[]" required="" style="border:none; width: 100%;" value="' + areaSqrft + '"></td>' +
        '<td><input type="text" name="areasqrmt[]" required="" style="border:none; width: 100%;" value="' + areaSqrmt + '"></td>' +
        '<td><input type="text" name="east[]" required="" style="border:none; width: 100%;" value="' + East + '"></td>' +
        '<td><input type="text" name="west[]" required="" style="border:none; width: 100%;" value="' + West + '"></td>' +
        '<td><input type="text" name="south[]" required="" style="border:none; width: 100%;" value="' + South + '"></td>' +
        '<td><input type="text" name="north[]" required="" style="border:none; width: 100%;" value="' + North + '"></td>' +
        '<td><input type="text" name="rate[]" required="" style="border:none; width: 100%;" value="' + Rate + '"></td>' +
        '<td><input type="text" name="amount[]" required="" style="border:none; width: 100%;" value="' + Amount + '"></td>' +
        '<td style="text-align:center; color:#FF0000"><button class="delete-row"><i class="fa fa-trash-o"></i></button></td>' +
    '</tr>';
