                        ...
                        <tbody>
                            @foreach ($agree as $index => $agreement)
                                <tr>
                                    ...
                                    <td data-id="{{ $agreement->id ?? '' }}" style="display:none;">
                                        {!! $agreement->description ?? '' !!}</td>
                                    </td>
                                    <td>
                                        <div style="display: flex;">
                                            ...
                                            <div style="margin-left:5px;">
                                                <button
                                                    ...
                                                    type="button" data-id="{{ $agreement->id ?? '' }}"
                                                    class="btn btn-info edit-button" data-toggle="tooltip"
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.edit-button', function() {
                ...
                window.location.href = '{{ route('agreement-master.edit', ':id') }}'.replace(':id',
                    agreementId);
            });
        });
    </script>
        ...
        $(document).ready(function() {
            $(document).on('click', '.delete-btn', function() {
                ...
                if (confirm('Are you sure you want to delete this agreement?')) {
                    $.ajax({
                        url: '{{ route('agreement-master.destroy', ':id') }}'.replace(':id',
                            agreementId),
                        type: 'get',
                        data: {
