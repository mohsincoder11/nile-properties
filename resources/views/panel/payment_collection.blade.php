            ...
            <div class="col-md-12" style="margin-top:5px;">
                <div class="panel panel-default">
                    <h5 class="panel-title"
                        ...
                        align="center">
                        <i class="fa fa-rupee"></i> &nbsp;Payment Details
                    </h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" style="margin-top:10px;">
                                ...
                                <div class="col-md-2 d-none" style="margin-top:15px; ">
                    ...
                    <form id="other-charges-form" action="{{ route('othercharge_store') }}" method="post">
                        ...
                        <div class="col-md-2" style="margin-top:5px;">
                            ...
                            <select name="charges_id" required="" class="form-control select" data-live-search="true">
                                <option disabled>Select Charge</option>
            ...
            $('#project-select').change(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        'refresh'); // Reinitialize Bootstrap Select if needed
                    },
...
`;
                            ...
                            documentsTableBody.append(
                                '<tr><td colspan="7" align="center">No documents found</td></tr>'
                                );
                        }
                    },
                    error: function(xhr, status, error) {
