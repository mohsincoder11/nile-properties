                ...
                <div class="col-md-12" style="margin-top: 2vh;">
                                ...
                                <option>Other</option> --}}
                                    ...
                                    @foreach ($occupation as $occupation_name)
                                        <option value="{{ $occupation_name->id }}"
                                            {{ old('occupation_id') == $occupation_name->id ? 'selected' : '' }}>
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                        ...
                        <tr>
                                ...
                                <select style="width:100%;" class="form-control select" data-live-search="true"
                                    ...
                                    @foreach ($branch as $branch_name)
                                        <option value="{{ $branch_name->id }}"
                                            {{ old('branch_id') == $branch_name->id ? 'selected' : '' }}>
                            ...
                            <td style="padding:2px;">
                                <input type="file" class="form-control" name="pan" value="{{ old('pan') }}"
                                    required />
                            </td>
                            <td style="padding:2px;">
                                    ...
                                    <td>
                                        <div style="display: flex;">
                                            ...
                                            <button style="background-color:#ff0000; border:none; max-height:25px;
                                                ...
                                                <a
                                                    onclick="openDeleteModal('{{ route('customerRegDestroy', $reg->id) }}')">
                                                    <button
