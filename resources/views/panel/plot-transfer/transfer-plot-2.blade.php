        ...
        <div class="row">
            ...
            <div class="col-md-12" style="margin-top:5px;">
                <div class="panel panel-default">
                    <form action="{{ route('plot-transfers.store', [$inquiry->id]) }}" method="post"
                                    ...
                                    <select id="client-select" class="form-control select" data-live-search="true">
                                        ...
                                        @foreach ($clients as $client)
                                            <option value="{{ $client->id ?? '' }}"
                                                ...
                                                data-pin-code="{{ $client->pin_code ?? '' }}"
                                                data-age="{{ $client->age ?? '' }}" data-dob="{{ $client->dob ?? '' }}"
                            ...
                            <div class="col-md-12" style="margin-top: 2vh;">
                                ...
                                <table style="width:100%;border-collapse:collapse;">
                                    ...
                                    <div style="width:100%;" class="input-group">
                                        ...
                                        <td style="padding: 2px;">
                                            <div class="input-group" style="width:100%;">
                                                <input type="text" id="dob" value="{{ old('dob') }}"
                                    ...
                                    <div style="width:100%;" class="input-group">
                                        ...
                                        <td style="padding: 2px;">
                                            <div class="input-group" style="width:100%;">
                                                <input type="text" id="marriage_date"
                                                    value="{{ old('marriage_date') }}" name="marriage_date"
                                        ...
                                        <td style="padding:2px;">
                                            <select style="width:100%;" class="form-control select"
                                                data-live-search="true" name="branch_id" id="branch_id">
                                                <option value="">Select Option</option>
                                    ...
                                    <tr>
                                        <td style="padding: 2px;" width="2%">
                                            <select id="project-select" name="project_id"
                                                class="form-control select no_click_readonly" data-live-search="true">
                                                @foreach ($projects as $project)
                                                    <option value="{{ $project->id }}"
                                                        data-project-id="{{ $project->id }}"
                                                        @if ($inquiry->project_id == $project->id) selected @endif>
                        ...
                        @endforeach --}}
                                            <input type="text" class="form-control"
                                                value="{{ $inquiry->plot_no ?? '' }}" name="plot_no" placeholder=""
                                                required readonly />
                                        ...
                                        <td style="padding: 2px;" width="1%">
                                            <input type="text" class="form-control" name="rate"
                                                value="{{ $inquiry->rate ?? '' }}" placeholder="" readonly />
                                        </td>
                                        <td style="padding: 2px;" width="1%">
                                            <label id="total_cost" class="control-label">
                                                <input id="total_cost_input" type="hidden"
                                                    value="{{ $inquiry->total_cost ?? '' }}" name="total_cost">
                                                <font id="total_cost_display" color="#ff0000">
                                                    {{ $inquiry->total_cost ?? '' }}</font>
                                            </label>
                                        </td>
                                        <td style="padding: 2px;" width="1%">
                                            <input type="text" class="form-control" name="discount_amount"
                                                value="{{ $inquiry->discount_amount ?? '' }}" placeholder="" readonly />
                                        </td>
                                        <td style="padding: 2px;" width="1%">
                                            <select class="form-control select no_click_readonly" data-live-search="true"
                                                name="discount_type" id="discount_type">
                                                <option value="">Select Option</option>
                                                <option value="%" @if (isset($inquiry->discount_type) && $inquiry->discount_type == '%') selected @endif>%
                                                </option>
                                                <option value="₹" @if (isset($inquiry->discount_type) && $inquiry->discount_type == '₹') selected @endif>₹
                                                </option>
                                            </select>
                                    ...
                                    <tr>
                                        <td style="padding: 2px;" width="1%">
                                            <input type="text" class="form-control" id="final_amount"
                                                name="final_amount" placeholder=""
                                                value="{{ $inquiry->final_amount ?? '' }}" readonly />
                                        </td>
                                        <td style="padding: 2px;" width="1%">
                                            <input type="text" class="form-control" name="down_payment"
                                                placeholder="" value="{{ $inquiry->down_payment ?? '' }}" readonly />
                                        </td>
                                        ...
                                        <td style="padding: 2px;" width="1%">
                                            <input type="text" class="form-control"
                                                value="{{ $inquiry->tenure ?? '' }}" name="tenure" placeholder=""
                                                readonly />
                                        </td>
                                        <td id="emi_ammount" style="padding: 2px;" width="1%">
                                            ...
                                            <label id="emi_ammount_label" class="control-label">
                                                <font id="emi_ammount_display" color="#ff0000">
                                                    {{ $inquiry->emi_amount ?? '' }}</font>
                                            </label>
                                        </td>
                                        <td style="padding: 2px;" width="1%">
                                            <div class="input-group" style="display: flex;">
                                                <input type="text" id="booking_date"
                                                    value="{{ date('m/d/Y', strtotime($inquiry->booking_date)) }}"
                                        ...
                                        <td style="padding: 2px;" width="1%">
                                            <div class="input-group" style="display: flex;">
                                                <input type="text" id="aggriment_date"
                                                    value="{{ date('m/d/Y', strtotime($inquiry->aggriment_date)) }}"
                                        ...
                                        <td style="padding: 2px;" width="1%">
                                            <select class="form-control select no_click_readonly" name="status_token"
                                                data-live-search="true">
                                                @foreach ($tokenStatuses as $tokenStatus)
                                                    <option value="{{ $tokenStatus->id }}"
                                                        @if ($inquiry->status_token == $tokenStatus->id) selected @endif>
                                                        {{ $tokenStatus->token }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <td style="padding: 2px;" width="1%">
                                            <div class="input-group" style="display: flex;">
                                                <input type="text" id="emi_start_date" name="emi_start_date"
                                                    value="{{ date('m/d/Y', strtotime($inquiry->emi_start_date)) }}"
                                    ...
                                    <tr>
                                            ...
                                            <select class="form-control select no_click_readonly" data-live-search="true"
                                                ...
                                                @foreach ($statuses as $status)
                                                    <option value="{{ $status->plot_sale_status }}"
                                                        @if ($inquiry->plot_sale_status == $status->plot_sale_status) selected @endif>
                                        ...
                                        <td style="padding: 2px;" width="1%">
                                            <input type="text" class="form-control" name="a_rate"
                                                value="{{ $inquiry->a_rate }}" placeholder="" readonly />
                                        </td>
                                        <td style="padding: 2px;" width="2%">
                                            <input type="radio" id="agent_name" name="source_type" value="agent"
                                                onclick="toggleEmployeeSelect()" disabled>
                                            <label for="agent_name">Agent Name</label>
                                            <input type="radio" id="executive_name" name="source_type"
                                                value="executive" onclick="toggleEmployeeSelect()" checked disabled>
                    ...
                    <select class="form-control select no_click_readonly" data-live-search="true" id="agent-select" name="agent_id" >
                        ...
                        @endforeach
                                        ...
                                        <td id="agent-select-container" style="padding: 2px; width: 1%;">
                                            <select class="form-control select no_click_readonly" data-live-search="true"
                                                id="agent-select" name="agent_id">
                                                <!-- Display an empty option if $inquiry->agent_id is null -->
                                                <option value="" @if (is_null($inquiry->agent_id)) selected @endif>
                                                    Select Agent</option>
                                                @foreach ($agent as $agent)
                                                    <option value="{{ $agent->id }}"
                                                        @if ($inquiry->agent_id == $agent->id) selected @endif>
                                                        {{ $agent->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                        ...
                        @endforeach
                                        ...
                                        <td id="employee-select-container" style="padding: 2px; width: 1%;">
                                            <select class="form-control select no_click_readonly" data-live-search="true"
                                                ...
                                                <option value="" @if (is_null($inquiry->employee_id)) selected @endif>
                                                    Select Employee</option>
                                                @foreach ($employees as $employee)
                                                    <option value="{{ $employee->id }}"
                                                        @if ($inquiry->employee_id == $employee->id) selected @endif>
                                                        {{ $employee->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <td style="padding: 2px;" width="1%">
                                            <textarea type="text" class="form-control" name="remark" placeholder="" rows="2" cols="5"
                                                readonly>{{ $inquiry->remark ?? '' }}</textarea>
                                        </td>
                                    </tr>
                                </table>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('add-client-btn').addEventListener('click', function() {
                ...
                if (selectedOption.value !== '') {
                    ...
                    const aadharUrl = clientData.aadhar ?
                        `{{ asset('customer_reg/${clientData.aadhar}') }}` : null;
...
`;
            ...
            document.querySelector('#customerTableBody').addEventListener('click', function(e) {
                if (e.target && (e.target.matches('.remove-row-btn') || e.target.matches(
                        '.remove-row-btn i'))) {
                    const row = e.target.closest('tr');
                    row.parentNode.removeChild(row);
                }
