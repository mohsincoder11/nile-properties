                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:2px;">
                                            <select style="width:100%;" class="form-control select"
                                                data-live-search="true" id="branch_id">
                                                <option value="">Select Option</option>
                                        ...
                                        @foreach ($client->clientn as $customer)
                                            <tr>
                                                <td style="padding:5px;" align="center">
                                                    ...
                                                    <input type="hidden" name="client_title_pre[]"
                                                        value="{{ $customer->title ?? '' }}">
                                                    <input type="hidden" name="client_id_pre[]"
                                                        value="{{ $customer->id ?? '' }}">
                                                </td>
                                                <td style="padding:5px;" align="center">
                                                    <label>{{ $customer->name ?? 'N/A' }}</label>
                                                    <input type="hidden" name="client_name_pre[]"
                                                        value="{{ $customer->name ?? '' }}">
                                                </td>
                                                <td style="padding:5px;" align="center">
                                                ...
                                                <td style="padding:5px;" align="center">
                                                    ...
                                                    <input type="hidden" name="client_email_pre[]"
                                                ...
                                                <td style="padding:5px;" align="center">
                                                    ...
                                                    <input type="hidden" name="client_city_pre[]"
                                                        value="{{ $customer->city ?? '' }}">
                                                </td>
                                                <td style="padding:5px;" align="center">
                                                ...
                                                <td style="padding:5px;" align="center">
                                                    ...
                                                    <input type="hidden" name="client_age_pre[]"
                                                        value="{{ $customer->age ?? '' }}">
                                                </td>
                                                <td style="padding:5px;" align="center">
                                                ...
                                                <td style="padding:5px;" align="center">
                                                    @if ($customer->marriage_date && $customer->marriage_date !== 'N/A')
                                                        <label>{{ \Carbon\Carbon::parse($customer->marriage_date)->format('d/m/y') }}</label>
                                                ...
                                                <td style="padding:5px;" align="center">
                                                    ...
                                                    @else
                                                        <label>N/A</label>
                                                    @endif
                                                    <input type="hidden" name="client_pan_pre[]"
                                                        value="{{ $customer->pan ?? '' }}">
                                                </td>
                                                <td style="padding:5px;" align="center">
                                            ...
                                            <select id="firm-select" name="firm_id" class="form-control select"
                                                ...
                                                @foreach ($firm as $firm)
                                                    <option value="{{ $firm->id }}"
                                                        @if ($inquiry->firm_id == $firm->id) selected @endif>
                                                        {{ $firm->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select id="plot-select" name="plot_no" class="form-control select"
                                                ...
                                                @foreach ($plot as $enquiry)
                                                    <option value="{{ $enquiry->id ?? '' }}"
                                                        @if (isset($inquiry) && $inquiry->plot_no == $enquiry->id) selected @endif>
                                                        {{ $enquiry->plot_no ?? '' }}
                                                    </option>
                                                @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px;" width="1%">
                                            <input type="text" class="form-control" name="down_payment"
                                                placeholder="" oninput="calculateAmounts()"
                                                value="{{ $inquiry->down_payment ?? '' }}" required />
                                        </td>
                                        ...
                                        <td id="emi_ammount" style="padding: 2px;" width="1%">
                                            <input type="hidden" name="emi_ammount"
                                                value="{{ $inquiry->emi_amount ?? '' }}" id="emi_ammount_input">
                                    ...
                                    <tr>
                                            ...
                                            <select class="form-control select" data-live-search="true"
                                                ...
                                                @foreach ($statuses as $status)
                                                    <option value="{{ $status->id }}"
                                                        @if (isset($inquiry) && $inquiry->plot_sale_status == $status->id) selected @endif>
                                        ...
                                        <td id="agent-select-container" style="padding: 2px; width: 1%;">
                                            <select class="form-control select" data-live-search="true" id="agent-select"
                                                name="agent_id"
                                                {{ $inquiry->agent_id ? '' : 'disabled' }}>
                                                <option value="">Select Option</option>
                                                @foreach ($agent as $agent)
                                                    <option value="{{ $agent->id }}"
                                                        {{ $inquiry->agent_id == $agent->id ? 'selected' : '' }}>
                                                        {{ $agent->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <td id="employee-select-container" style="padding: 2px; width: 1%;">
                                            <select class="form-control select" data-live-search="true"
                                                ...
                                                {{ $inquiry->employee_id && !$inquiry->direct_sourse ? '' : 'disabled' }}>
                                                <option value="">Select Option</option>
                                                @foreach ($employees as $employee)
                                                    <option value="{{ $employee->id }}"
                                                        {{ $inquiry->employee_id == $employee->id ? 'selected' : '' }}>
                                                        {{ $employee->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <td style="padding: 2px;" width="1%">
                                            <textarea type="text" class="form-control" name="remark" placeholder="" rows="2" cols="5">{{ $inquiry->remark ?? '' }}</textarea>
                                        </td>
            ...
            $('.delete-nominee-btn_pre').click(function() {
                ...
                if (confirm('Are you sure you want to delete this nominee?')) {
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            alert(
                                'An error occurred while deleting the nominee. Please try again.');
                        }
                    });
                }
            });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('add-client-btn').addEventListener('click', function() {
                ...
                if (selectedOption.value !== '') {
                    ...
                    const panUrl = clientData.pan ? `{{ asset('customer_reg/${clientData.pan}') }}` :
                    null;
