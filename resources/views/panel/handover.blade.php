                ...
                <table class="table datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form id="form-{{ $enquiry->id }}" action="{{ route('handover_with_date_file') }}"
                                ...
                                <div class="align-items-center" style="display: flex!important;">
                                    ...
                                    <div class="input-group datepicker-container">
                                        <input type="text" id="date1-{{ $enquiry->id }}"
                                            value="{{ old('date', $enquiry->handover_completed_date ? \Carbon\Carbon::parse($enquiry->handover_completed_date)->format('m/d/Y') : '') }}"
                                    ...
                                    @if($enquiry->is_handover_completed == 1)
                                    <button data-id="{{ $enquiry->id }}"
