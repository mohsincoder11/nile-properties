            ...
            <ul class="x-navigation x-navigation-horizontal">
                ...
                <li class="xn-openable">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('newsale')}}"><span class="fa fa-plus"></span>New Sale Confirmed</a></li>
                        ...
                        <li><a href="{{ route('registrationcompleted')}}"><span class="fa fa-plus"></span>Registration
                                Completed</a></li>
                        <li><a href="{{ route('saledeedscan')}}"><span class="fa fa-plus"></span>Saledeed Scan</a></li>
                        <li><a href="{{ route('handover')}}"><span class="fa fa-plus"></span>Handover Complete</a></li>
                    </ul>
                </li>
                <li class="xn-openable">
