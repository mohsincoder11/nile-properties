    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="col-md-6"><br>
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th> ( <label class="check">Delete <input type="checkbox" class="" id="checkAlldelete2"
                                        onclick="checkalldelete(2)"></label> )</th>
                        </tr>
                        <tr>
                    ...
                    <table class="table table-bordered" style="margin-top: -10px;">
                        ...
                        <tr>
                            ...
                            <th> ( <label class="check">Pay <input type="checkbox" class="" id="checkAllread3"
                                        onclick="checkallread(3)"></label> )</th>
                            <th> ( <label class="check">Update <input type="checkbox" class="" id="checkAlledit3"
                                        onclick="checkalledit(3)"></label> )</th>
                        </tr>
                        <tr>
            ...
            <div class="col-md-12" align="center">
                <button id="on" type="button" class="btn mjks" style="color:#FFFFFF; height:30px; width:auto;"> <i
                        class="fa fa-users"></i>Add User</button>
