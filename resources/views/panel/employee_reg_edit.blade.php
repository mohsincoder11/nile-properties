                    ...
                    <tr>
                        <td style="padding: 2px;" width="3%">
                            <select class="form-control select" data-live-search="true" name="role">
                                ...
                                <option value="Admin" {{old('role', $employeeEdit->role)== 'Admin'? 'selected':
                                    ''}}>Admin</option>
                                <option value="Reception" {{old('role', $employeeEdit->role)=='Reception'? 'selected' :
                                    ''}}>Reception</option>
                                <option value="Employee" {{old('role', $employeeEdit->role)=='Employee'? 'selected':
                                    ''}}>Employee</option>
                            </select>
                        </td>
        ...
        <table width="100%" border="1" id="bank_details">
            ...
            <tbody class="add_more">
                ...
                <tr>
                    ...
                    <td>
                        <input type="hidden" name="existing_id[]" value="{{ $empListEdit->id }}"> <input type="hidden"
                            name="employee_id[]" value="{{ $empListEdit->employee_id }}"><input type="text" required=""
                            style="border:none; width: 100%;" name="account_holder_name[]"
                            value="{{ $empListEdit->account_holder_name }}">
                    </td>
                    <td><input type="text" name="bank_name[]" required="" style="border:none; width: 100%;" value={{
                            $empListEdit->bank_name }}></td>

                    <td><input type="text" name="account_number[]" required="" style="border:none; width: 100%;"
                            value={{ $empListEdit->account_number }}></td>
