                    ...
                    <div class="icon-box-container">
                        <div class="icon-box box-2">
                            <a href="{{ route('enquiry') }}">
                                <img src="{{ asset('panel/assets/images/cards/3.png') }}" alt=""
                                    class="classic-1" />
                        ...
                        <div class="icon-box box-3" style="padding: 1vh">
                            <a href="{{ route('newclientindex') }}">
                                <img src="{{ asset('panel/assets/images/cards/man.png') }}" alt=""
                                    class="classic-1" />
                        ...
                        <div class="icon-box box-1" style="padding: 1vh">
                            <a href="{{ route('visitindex') }}">
                                <img src="{{ asset('panel/assets/images/cards/map.png') }}" alt=""
                                    class="classic-1" />
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea rows="2" cols="20" class="form-control" id="editor" placeholder="" name=" "></textarea>
                            </div>
